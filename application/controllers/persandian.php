...
class persandian extends CI_Controller {	
	...
	public function index(){
		$data['honor'] = $this->honor_model->view_persandian();
		$this->load->view('admin/thl/persandian_view', $data);
	}	


public function detail($id) {
    $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/persandian_detail', $data);
  }

  public function persandian_public(){
    $data['honor'] = $this->honor_model->view_persandian();
    $this->load->view('admin/thl/persandian_public', $data);
  } 
  public function persandian_print(){
    $data['honor'] = $this->honor_model->view_persandian();
    $this->load->view('admin/thl/persandian_print', $data);
  } 

   public function persandian_detail_print(){
    $data['honor'] = $this->honor_model->view_persandian();
    $this->load->view('admin/thl/persandian_detail_print', $data);
  } 
  ...
  public function tambah(){
    ...
    if($this->input->post('submit')){
      ...
      if($upload['result'] == "success"){ 
        ...
        redirect('persandian'); // Redirect kembali ke halaman awal / halaman view data
      }
...
public function hapus($id){
  		...
  		redirect('persandian'); //mengalihkan halaman
	}

	  public function edit($id) {
	  $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/persandian_edit', $data);
	}
