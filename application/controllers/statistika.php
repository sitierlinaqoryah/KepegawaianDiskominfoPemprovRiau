...
class statistika extends CI_Controller {	
	...
	public function index(){
		$data['honor'] = $this->honor_model->view_statistika();
		$this->load->view('admin/thl/statistika_view', $data);
	}	


public function Detail($id) {
    $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/statistika_detail', $data);
  }

  public function statistika_public(){
    $data['honor'] = $this->honor_model->view_statistika();
    $this->load->view('admin/thl/statistika_public', $data);
  } 
  public function statistika_print(){
    $data['honor'] = $this->honor_model->view_statistika();
    $this->load->view('admin/thl/statistika_print', $data);
  } 

   public function statistika_detail_print(){
    $data['honor'] = $this->honor_model->view_statistika();
    $this->load->view('admin/thl/statistika_detail_print', $data);
  } 
  ...
  public function tambah(){
    ...
    if($this->input->post('submit')){
      ...
      if($upload['result'] == "success"){ 
        ...
        redirect('statistika'); // Redirect kembali ke halaman awal / halaman view data
      }
...
public function hapus($id){
  		...
  		redirect('statistika'); //mengalihkan halaman
	}

	  public function edit($id) {
	  $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/statistika_edit', $data);
	}
