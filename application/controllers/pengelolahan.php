...
class pengelolahan extends CI_Controller {	
	...
	public function index(){
		$data['honor'] = $this->honor_model->view_pengelolahan();
		$this->load->view('admin/thl/pengelolahan_view', $data);
	}	


public function detail($id) {
    $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/pengelolahan_detail', $data);
  }

  public function pengelolahan_public(){
    $data['honor'] = $this->honor_model->view_pengelolahan();
    $this->load->view('admin/thl/pengelolahan_public', $data);
  } 
  public function pengelolahan_print(){
    $data['honor'] = $this->honor_model->view_pengelolahan();
    $this->load->view('admin/thl/pengelolahan_print', $data);
  } 

   public function pengelolahan_detail_print(){
    $data['honor'] = $this->honor_model->view();
    $this->load->view('admin/thl/pengelolahan_detail_print', $data);
  } 
  ...
  public function tambah(){
    ...
    if($this->input->post('submit')){
      ...
      if($upload['result'] == "success"){ 
        ...
        redirect('pengelolahan'); // Redirect kembali ke halaman awal / halaman view data
      }
...
public function hapus($id){
  		...
  		redirect('pengelolahan'); //mengalihkan halaman
	}

	  public function edit($id) {
	  $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/pengelolahan_edit', $data);
	}
