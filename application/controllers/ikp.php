...
class ikp extends CI_Controller {	
	...
	public function index(){
		...
		$this->load->view('admin/thl/ikp_view', $data);
	}	


public function ikp_detail($id) {
    $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/ikp_detail', $data);

  }

  public function ikp_public(){
    $data['honor'] = $this->honor_model->view();
    $this->load->view('admin/thl/ikp_public', $data);
  } 
  public function ikp_print(){
    $data['honor'] = $this->honor_model->view();
    $this->load->view('admin/thl/ikp_print', $data);
  } 
  ...
  public function tambah(){
    ...
    if($this->input->post('submit')){
      ...
      if($upload['result'] == "success"){ 
        ...
        redirect('ikp'); // Redirect kembali ke halaman awal / halaman view data
      }
...
public function hapus($id){
  		...
  		redirect('ikp'); //mengalihkan halaman
	}

	  public function edit($id) {
	  $data['honor'] = $this->honor_model->getid($id);
    $this->load->view('admin/thl/ikp_edit', $data);
	}
