                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">THL Diskominfo Provinsi Riau</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<?php echo form_open("honor/tambah", array('enctype'=>'multipart/form-data')); ?>
	<div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="nama" name="nama" class="form-control" value=" <?php echo set_value('nama'); ?>" ><small class="form-text text-muted"></small></div>
                          </div>


     <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomor SPK</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="no_spk" name="no_spk" class="form-control" value="<?php echo set_value('no_spk'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
    ...
    <div class="row form-group">
                          ...
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">NIK</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="nik" name="nik" class="form-control" value="<?php echo set_value('nik'); ?>"><small class="form-text text-muted"></small></div>
                          </div>


                          <div class="row form-group">
                          <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomor Rekening</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="no_rek" name="no_rek" class="form-control" value="<?php echo set_value('no_rek'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
                    ...
                    <div class="row form-group">
                         ...
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">TMT Bekerja</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tmt_kerja" name="tmt_kerja"  class="form-control" value="<?php echo set_value('tmt_kerja'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
    <div class="row form-group">
                             <div class="col col-md-3"><label for="text-input" class=" form-control-label">Alamat</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="alamat" name="alamat" class="form-control" value="<?php echo set_value('alamat'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
    <div class="row form-group">
                           <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tempat Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" value="<?php echo set_value('tempat_lahir'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
    <div class="row form-group">
                      
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tgl_lahir" name="tgl_lahir"  class="form-control" value="<?php echo set_value('tgl_lahir'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
    <div class="row form-group">

                             <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nomor Telphone</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="no_tlpn" name="no_tlpn" class="form-control" value="<?php echo set_value('no_tlpn'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
                   ...
                   <div class="col col-md-3">
                    <label for="text-input" class=" form-control-label">Gaji</label>
                           </div>

                            <div class="col-12 col-md-9">
              <input type="text" id="gaji" name="gaji" class="form-control" value="<?php echo set_value('gaji'); ?>" >
                                <input type="hidden" class="form-control" id="gaji" name="gaji" >
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="email" name="email" class="form-control" value="<?php echo set_value('email'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
                        <div class="row form-group">
                       ...
                       <div class="col col-md-3"><label for="text-input" class=" form-control-label">Pendidikan</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="pendidikan" name="pendidikan" class="form-control" value="<?php echo set_value('pendidikan'); ?>"><small class="form-text text-muted"></small></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="file" id="foto" name="foto" class="form-control-file" value="upload"></div>
                          </div>
 
                      </div>
    <hr>
    <input type="submit" name="submit" value="Simpan">
    <a href="<?php echo base_url().'index.php/menu_thl' ?>"><input type="button" value="Batal"></a>
<?php echo form_close(); ?>
...
<script>
    ...
    function todesimal(){
        $("#gaji").maskMoney({thousands:'.',precision:0});
        var gaji = $("#gaji").val();
        var gaji = gaji.replace(/[^0-9]/g, '');
        $("#gaji").val(gaji);  
