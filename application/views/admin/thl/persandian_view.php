                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo site_url('persandian/persandian_print/') ?>" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('persandian/edit/' . $item->no) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                                                
                                               <a href="<?php echo site_url('persandian/hapus/' . $item->no) ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus?')"><i class="fa fa-delete"></i> Hapus</a>
                                               
                                               <a href="<?php echo site_url('persandian/detail/'.$item->no) ?>" class=" btn  btn-warning"> <i class=" fa fa-delete"></i> Detail</a>
