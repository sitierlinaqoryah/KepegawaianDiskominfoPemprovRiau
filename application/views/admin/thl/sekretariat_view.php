                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Bidang Sekretariat Diskominfo</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo site_url('sekretariat/sekretariat_print/') ?>" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo site_url('sekretariat/edit/' . $item->no) ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                                                
                                               <a href="<?php echo site_url('sekretariat/hapus/' . $item->no) ?>" class="btn btn-danger" onclick="return confirm('Yakin Hapus?')"><i class="fa fa-delete"></i> Hapus</a>
                                               
                                               <a href="<?php echo site_url('sekretariat/detail/'.$item->no) ?>" class=" btn  btn-warning"> <i class=" fa fa-delete"></i> Detail</a>
