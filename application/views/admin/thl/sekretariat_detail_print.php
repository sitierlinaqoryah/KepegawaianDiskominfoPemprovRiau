           ...
           <div class="col-md-12">
                        <aside class="profile-nav alt">
                                ...
                                <div class="card-header ">
                                    ...
                                    <div class="media" >            
                                                <?php
if( ! empty($thl_ikp)){ // Jika data pada database tidak sama dengan empty (alias ada datanya)
    foreach($thl_ikp as $r){ 
                                     echo "<img src='".base_url("images/thl_ikp/".set_value('no',$r->foto))."' width=85px height=85px>" ;?>
                                        </a>
