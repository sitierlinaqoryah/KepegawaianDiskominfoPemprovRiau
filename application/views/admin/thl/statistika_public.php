...
<
            <div class="navbar-collapse collapse">  <a href="<?php echo base_url().'index.php/honor/menu_public' ?>" class="btn btn-lg btn-block btn-success"  >Tenaga Harian Lepas Bidang Statistika Diskominfo</a>
