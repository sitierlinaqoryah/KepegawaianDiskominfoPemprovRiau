                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Thl Statistika Diskominfo</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">THL Statistika Diskominfo</strong>
                        </div>
                        <div class="card-body">
...
<div style="color: red;"><?php echo (isset($message))? $message : ""; ?></div>
                             ...
                             <?=form_open_multipart('statistika/prosesedit/'.$r->no)?>
     <!--<form action="<?php echo site_url('statistika/prosesedit/'.$r->no_pegawai); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">-->
