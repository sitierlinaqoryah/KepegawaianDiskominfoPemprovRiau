...
<?php echo form_open("pangkat/tambah", array('enctype'=>'multipart/form-data')); ?>
        ...
        7
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal Kenaikan Pangkat</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tgl_pangkat" name="tgl_pangkat" class="form-control" value="<?php echo set_value('tgl_pangkati');?>"><small class="form-text text-muted"></small></div>
                          </div>
                
		
	<hr>
	<input type="submit" name="submit" value="Simpan">
	<a href="<?php echo base_url('pangkat/naik_golongan'); ?>"><input type="button" value="Batal"></a>
<?php echo form_close(); ?>
