           ...
           <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('tabel_pegawai')?></span>
                        </h4>
                        <p class="text-light">Total pegawai</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('view_sekretariat')?></span>
                        </h4>
                        <p class="text-light">Total THL Sekretariat Diskominfo</p>
           ...
           <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('view_ikp')?></span>
                        </h4>
                        <p class="text-light">Total THL Bidang IKP Diskominfo</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('view_pengelolahan')?></span>
                        </h4>
                        <p class="text-light">Total THL Pengelolahan Infrastruktur Diskominfo</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('view_persandian')?></span>
                        </h4>
                        <p class="text-light">Total THL Bidang Persandian</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('view_statistika')?></span>
                        </h4>
                        <p class="text-light">Total THL Bidang Statistika Diskominfo</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('tabel_magangfix')?></span>
                        </h4>
                        <p class="text-light">Total Kerja Praktek Diskominfo</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('tabel_magang')?></span>
                        </h4>
                        <p class="text-light">Total Pengajuan Magang Diskominfo</p>
  ...
  <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><?php echo $this->db->count_all('tabel_pensiun')?></span>
                        </h4>
                        <p class="text-light">Total Pensiun</p>
