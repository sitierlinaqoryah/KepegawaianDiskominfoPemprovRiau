...
<?php echo form_open("pegawai/tambah", array('enctype'=>'multipart/form-data')); ?>
	    
                      
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">NIP Pegawai</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="nip_pegawai" name="nip_pegawai" class="form-control" value="<?php echo set_value('nip_pegawai');?>"><small class="form-text text-muted"></small></div>
                          </div>
						  
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Pegawai</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="nama_pegawai" name="nama_pegawai" class="form-control" value="<?php echo set_value('nama_pegawai');?>"><small class="form-text text-muted"></small></div>
                          </div>
						  
                          <div class="row form-group">
                           <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tempat Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="tempat_pegawai" name="tempat_pegawai" class="form-control" value="<?php echo set_value('tempat_pegawai');?>"><small class="form-text text-muted"></small></div>
                          </div>
						  
						  <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal lahir</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tggllahir_pegawai" name="tggllahir_pegawai"  class="form-control" value="<?php echo set_value('tgllahir_pegawai');?>"><small class="form-text text-muted"></small></div>
                          </div>
						  
                          <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Pangkat Terakhir</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="pangkat_terakhir" name="pangkat_terakhir"  class="form-control" value="<?php echo set_value('pangkat_terakhir');?>" ><small class="form-text text-muted"></small></div>
                          </div>
						  
                           <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">TMT Pegawai</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tmt_pegawai" name="tmt_pegawai"  class="form-control" value="<?php echo set_value('tmt_pegawai');?>"><small class="form-text text-muted"></small></div>
                          </div>
						  
                        <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">No SK</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="no_sk" name="no_sk"  class="form-control"><small class="form-text text-muted" value="<?php echo set_value('no_sk');?>"></small></div>
                          </div>
                         ...
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal SK</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tgl_sk" name="tgl_sk"  class="form-control"><small class="form-text text-muted" value="<?php echo set_value('tgl_sk');?>"></small></div>
                          </div>
                          <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Jabatan Pegawai</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="jabatan_pegawai" name="jabatan_pegawai"  class="form-control"><small class="form-text text-muted" value="<?php echo set_value('jabatan_pegawai');?>"></small></div>
                          </div>
                            <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">TMT Pegawai</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tmt2_pegawai" name="tmt2_pegawai"  class="form-control"><small class="form-text text-muted" value="<?php echo set_value('tmt2_pegawai');?>"></small></div>
                          </div>
						    <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">No SK</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="no_sk2" name="no_sk2"  class="form-control" value="<?php echo set_value('no_sk2');?>"><small class="form-text text-muted"></small></div>
                          </div>
                         
                          <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal SK</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="tgl_sk2" name="tgl_sk2"  class="form-control" value="<?php echo set_value('tgl_sk2');?>"><small class="form-text text-muted"></small></div>
                          </div>
						   <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Eselon Pegawai</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="eselon_pegawai" name="eselon_pegawai"  class="form-control" value="<?php echo set_value('eselon_pegawai');?>"><small class="form-text text-muted"></small></div>
                          </div>
						  
						 <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">PendidikanFormal</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="pendidikan_formal" name="pendidikan_formal"  class="form-control" value="<?php echo set_value('pendidikan_formal');?>"><small class="form-text text-muted"></small></div>
                          </div>
						  
						  <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Pendidikan Perjenjangan</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="pendidikan_perjenjangan" name="pendidikan_perjenjangan"  class="form-control" value="<?php echo set_value('pendidikan_perjenjangan');?>"><small class="form-text text-muted"></small></div>
                          </div>
                        
						  
						  <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">Pengalaman Kerja</label></div>
                            <div class="col-12 col-md-9"><input type="text-area" id="pengalaman_kerja" name="pengalaman_kerja"  class="form-control" value="<?php echo set_value('pengalaman_kerja');?>"><small class="form-text text-muted"></small></div>
                          </div>
						
                          <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">No Karis </label></div>
                            <div class="col-12 col-md-9"><input type="text" id="karis" name="karis"  class="form-control" value="<?php echo set_value('karis');?>"><small class="form-text text-muted"></small></div>
                          </div>
                            <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">No Karsu </label></div>
                            <div class="col-12 col-md-9"><input type="text" id="karsu" name="karsu"  class="form-control" value="<?php echo set_value('karsu');?>"><small class="form-text text-muted"></small></div>
                          </div>
                          <div class="row form-group">
                         <div class="col col-md-3"><label for="text-input" class=" form-control-label">No Karpeg</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="karpeg" name="karpeg"  class="form-control" value="<?php echo set_value('karpeg');?>"><small class="form-text text-muted"></small></div>
                          </div>
                          <div class="row form-group">
					...
					<option value="13">Kepala Dinas </option>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="file" id="foto_pegawai" name="foto_pegawai" class="form-control-file" value="upload"></div>
                          </div>
                      </div>
