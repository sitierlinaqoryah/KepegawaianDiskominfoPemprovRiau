	 ...
	 <table id="datatable" class="table table-bordered table-hover">
                            ...
                            <section class="card">
                                <div class="card-header user-header alt bg-dark">
                                    ...
                                    <img src="<?php echo base_url('images/'.$r->foto_magang);?>" width=100px height=100px>      
                                        ...
                                        <div class="media-body">
                                            <h2 class="text-light display-6">&nbsp <?php echo set_value('nama_magang',$r->nama_magang);?></h2>
									...
									<tr>
                                    <th><label>Nomor Hp :</label><br><br><?php echo set_value('nohp_magang',$r->nohp_magang) ;?></th>
                                    </tr>
