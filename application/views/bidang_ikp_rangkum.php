					...
					<div class="col-sm-12">
						<div class="title">
							<h3>Bidang Informasi & <span>Komunikasi Publik</span></h3>
									<center><a class="btn btn-lg btn-block btn-success"  href="<?php echo site_url('bidang_publik/get_ikp'); ?>">Daftar pegawai</a></center>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="single-feature wow fadeInLeft">
							<div class="row">
								...
								<div class="col-md-11">
									<div class="feature-text">
										<h4>Fungsi</h4>
										<p><b>Bidang Informasi dan Komunikasi Publik mempunyai fungsi:</b>
<ol>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan penyusunan dan pengembangan kebijakan teknis perencanaan dan program keija pada Bidang Informasi dan Komunikasi Publik;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan upaya peningkatan pelayanan publik di Bidang Informasi dan Komunikasi Publik;
</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan perencanaan, pembinaan, pengembangan, pemberdayaan, pemantauan dan pengendalian pelaksanaan kegiatan pengelolaan informasi publik dan komunikasi publik;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan perencanaan, pembinaan, pengembangan, pemberdayaan, pemantauan dan pengendalian pelaksanaan kegiatan kemitraan informasi dan komunikasi publik;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan monitoring, evaluasi dan laporan pelaksanaan tugas pada Bidang Informasi dan Komunikasi Publik; dan
<li/>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
