		...
		<section id="features" class="site-padding">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<div class="title">
							<h3>Bidang<span> Persandian</span></h3>
							<center><a class="btn btn-lg btn-block btn-success" href="<?php echo site_url('bidang_publik/get_sandi'); ?>">Daftar pegawai</a></center>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="feature-text">
										<h4>Tugas Pokok :</h4>
										<p>Melaksanakan penyiapan perumusan kebijakan, koordinasi dan pelaksanaan kebijakan, evaluasi dan pelaporan di bidang tata kelola persandian, pengamanan persandian dan informasi, dan sistem komunikasi intra pemerintah</p></br></br>
						...
						<div class="single-feature wow fadeInLeft">
							<div class="row">
								...
								<div class="col-md-11">
									<div class="feature-text">
										<h4>Fungsi</h4>
										<p><b>Bidang Persandian mempunyai fungsi:</b>
<ol>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
Penyiapan bahan perumusan kebijakan, koordinasi dan pelaksanaan kebijakan, evaluasi dan pelaporan di bidang tata kelola persandian;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
...
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
Penyiapan bahan perumusan kebijakan, koordinasi dan pelaksanaan kebijakan, evaluasi dan pelaporan di bidang sistem komunikasi intra pemerintah;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
