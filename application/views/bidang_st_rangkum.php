		...
		<section id="features" class="site-padding">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<div class="title">
							<h3>Bidang<span> Statistik</span></h3>
							<center><a class="btn btn-lg btn-block btn-success" href="<?php echo site_url('bidang_publik/get_st'); ?>">Daftar pegawai</a></center>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="feature-text">
										<h4>Tugas Pokok :</h4>
										<p>Bidang Statistik mempunyai tugas melaksanakan sebagian tugas Dinas meliputi perencanaan kegiatan, menyusun pedoman dan petunjuk teknis, membina dan menyelenggarakan layanan informasi dan statistik.</p></br></br>
						...
						<div class="single-feature wow fadeInLeft">
							<div class="row">
								...
								<div class="col-md-11">
									<div class="feature-text">
										<h4>Fungsi</h4>
										<p><b>Bidang Statistik mempunyai fungsi:</b>
<ol>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan penyusunan dan pengembangan kebijakan teknis perencanaan dan program kerja pada Bidang Layanan Informasi dan Statistik;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan upaya peningkatan pelayanan publik di Bidang Layanan Informasi dan Statistik;
</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan perencanaan, pembinaan, pengembangan, pemberdayaan, pemantauan dan pengendalian pelaksanaan kegiatan pelayanan informasi dan statistik;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan perencanaan, pembinaan, pengembangan, pemberdayaan, pemantauan dan pengendalian pelaksanaan kegiatan pengelolaan sumberdaya dan layanan informasi;</li>
<li><img src="<?php echo base_url();?>'../../resources/img/Bullet.png" width="10" height="10"/>
pelaksanaan monitoring, evaluasi dan laporan pelaksanaan tugas pada Bidang Layanan Informasi dan Statistik dan pelaksanaan tugas kedinasan lain yang diberikan oleh atasan
<li/>
</p>
									</div>
								</div>
