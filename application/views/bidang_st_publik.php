			...
			<div class="container">
							...
							<div class="row">
								<div class="col-md-10">
									<div class="feature-text">
										...
										<h4>Daftar pegawai yang berada di Bidang Statistik</h4>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<!-- Single Feature-->
					     ...
					     <table id="bootstrap-data-table" class="table table-striped table-bordered"  <table id="bootstrap-data-table" class="table table-striped table-bordered" border="0">
                    <thead>
                      <tr>
